    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        },
        {
          ...
          value: [
            '• **`/th-daily`** — Claim your daily Trinkets once per day. Streak bonuses apply:',
            '> Day 1: **100 🪙**',
            '> Day 2: **150 🪙**',
            '> Day 3: **200 🪙**',
            '> Day 4: **250 🪙**',
            ...
            '',
            '• **Queue Participation** — Earn **20 🪙** when a queue you are in naturally closes. Fill list players earn **5 🪙**. Once per day, resets at **7pm EST**.',
          ].join('\n'),
        },
        {
          name: '🎰 How to Spend Trinkets',
          value: [
            '• **`/th-coinflip amount`** — Bet on a coin flip. Minimum **10 🪙**.',
            '• **`/th-bet @user amount`** — Challenge a user to a Trinket duel. Minimum **10 🪙**.',
        ...
        },
        {
          ...
          value: [
            ...
            '• `/th-leaderboard` — Top 3 Trinket holders',
